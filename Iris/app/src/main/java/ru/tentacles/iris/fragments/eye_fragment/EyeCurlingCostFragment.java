...
public class EyeCurlingCostFragment extends ActionBarActivity{
    ...
    class UpdateCost extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... args) {
            ...
            Intent cu = getIntent();
            int k = cu.getIntExtra("eyeCurling", 20);
            String id_eye = null;
            //В зависимости от позиции (нажатой кнопки) мы отправляем
            //в SQL запрос id требуемой нами услуги
            if (k == 0) {
                id_eye = "16";
                block_name.setText("Химическая завивка ресниц:");
            } else if (k == 1) {
                id_eye = "17";
                block_name.setText("Биозавивка ресниц:");
            }
    ...
    class LoadCost extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pDialog = new ProgressDialog(EyeCurlingCostFragment.this);
        ...
        protected void onPostExecute(String s) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(EyeCurlingCostFragment.this, mClassicList,
                            R.layout.list_item,
                            new String[]{TAG_id,
