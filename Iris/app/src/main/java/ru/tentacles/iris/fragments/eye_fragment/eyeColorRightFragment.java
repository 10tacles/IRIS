...
public class eyeColorRightFragment extends ListFragment{

    public static final String TAG = "eyeColorRightFragmentTAG";
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent ce = new Intent(getActivity(), EyeColorCostFragment.class);
        ce.putExtra("eyeColor", position);
        startActivity(ce);
    }
}
