...
// Выводит салоны и цены на услуги подблока "Окрашивание"
// блока "Глаза"
...
public class EyeColorCostFragment extends ActionBarActivity{
    ...
    class LoadCost extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pDialog = new ProgressDialog(EyeColorCostFragment.this);
        ...
        protected void onPostExecute(String s) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(EyeColorCostFragment.this, mClassicList,
                            R.layout.list_item,
                            new String[]{TAG_id,
