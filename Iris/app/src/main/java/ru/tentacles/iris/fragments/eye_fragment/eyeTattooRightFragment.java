...
public class eyeTattooRightFragment extends ListFragment{

    public static final String TAG = "eyeTattooRightFragmentTAG";
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent ta = new Intent(getActivity(), EyeTattooCostFragment.class);
        ta.putExtra("tattoo", position);
        startActivity(ta);
    }
}
