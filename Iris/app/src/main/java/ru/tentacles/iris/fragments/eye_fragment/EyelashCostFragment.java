...
// Выводит салоны и цены на услуги подблока "Наращивание ресниц"
// блока "Глаза"
public class EyelashCostFragment extends ActionBarActivity{
    ...
    class UpdateCost extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... args) {
            ...
            Intent le = getIntent();
            int j = le.getIntExtra("eyeLash", 20);
            String id_eye = null;
            //В зависимости от позиции (нажатой кнопки) мы отправляем
            //в SQL запрос id требуемой нами услуги
            if (j == 0) {
                id_eye = "10";
                block_name.setText("Поресничное наращивание:");
            } else if (j == 1) {
                id_eye = "11";
                block_name.setText("Коррекция поресничного наращивания:");
            }else if (j == 2) {
                id_eye = "12";
                block_name.setText("Пучковое наращивание ресниц:");
            }else if (j == 3) {
                id_eye = "13";
                block_name.setText("Коррекция пучкового наращивания:");
            }else if (j == 4) {
                id_eye = "14";
                block_name.setText("Декор ресниц:");
            }else if (j == 5) {
                id_eye = "15";
                block_name.setText("Снятие ресниц:");
            }
    ...
    class LoadCost extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pDialog = new ProgressDialog(EyelashCostFragment.this);
        ...
        protected void onPostExecute(String s) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(EyelashCostFragment.this, mClassicList,
                            R.layout.list_item,
                            new String[]{TAG_id,
