...
// Выводит салоны и цены на услуги подблока "Оформление бровей"
// блока "Глаза"
...
public class EyebrowCostFragment extends ActionBarActivity{
    ...
    class LoadCost extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pDialog = new ProgressDialog(EyebrowCostFragment.this);
        ...
        protected void onPostExecute(String s) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(EyebrowCostFragment.this, mClassicList,
                            R.layout.list_item,
                            new String[]{TAG_id,
