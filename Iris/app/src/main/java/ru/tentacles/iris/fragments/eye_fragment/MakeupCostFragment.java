...
// Выводит салоны и цены на услуги подблока "Макияж"
// блока "Глаза"
...
public class MakeupCostFragment extends ActionBarActivity{
    ...
    class UpdateCost extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... args) {
            ...
            Intent me = getIntent();
            int b = me.getIntExtra("makeup", 20);
            String id_eye = null;
            //В зависимости от позиции (нажатой кнопки) мы отправляем
            //в SQL запрос id требуемой нами услуги
            if (b == 0) {
                id_eye = "1";
                block_name.setText("Дневной макияж:");
            } else if (b == 1) {
                id_eye = "2";
                block_name.setText("Вечерний макияж:");
            } else if (b == 2) {
                id_eye = "3";
                block_name.setText("Свадебный макияж:");
            } else if (b == 3) {
                id_eye = "4";
                block_name.setText("(Макияж)выезд на дом:");
            } else if (b == 4) {
                id_eye = "5";
                block_name.setText("Удаления макияжа (демакияж):");
            }
    ...
    class LoadCost extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pDialog = new ProgressDialog(MakeupCostFragment.this);
        ...
        protected void onPostExecute(String s) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(MakeupCostFragment.this, mClassicList,
                            R.layout.list_item,
                            new String[]{TAG_id,
