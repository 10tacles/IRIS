...
public class eyeCurlingRightFragment extends ListFragment{

    public static final String TAG = "eyeCurlingRightFragmentTAG";
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent cu = new Intent(getActivity(), EyeCurlingCostFragment.class);
        cu.putExtra("eyeCurling", position);
        startActivity(cu);
    }
}
