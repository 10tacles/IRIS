...
// Выводит салоны и цены на услуги подблока "Татуаж"
// блока "Глаза"
public class EyeTattooCostFragment extends ActionBarActivity{
    ...
    class UpdateCost extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... args) {
            ...
            Intent ta = getIntent();
            int m = ta.getIntExtra("tattoo", 20);
            String id_eye = null;
            //В зависимости от позиции (нажатой кнопки) мы отправляем
            //в SQL запрос id требуемой нами услуги
            if (m == 0) {
                id_eye = "21";
                block_name.setText("Татуаж бровей:");
            } else if (m == 1) {
                id_eye = "22";
                block_name.setText("Татуаж век:");
            } else if (m == 2) {
                id_eye = "23";
                block_name.setText("Межресничное пространство:");
            }else if (m == 3) {
                id_eye = "24";
                block_name.setText("Стрелка с растушевкой:");
            }
    ...
    class LoadCost extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pDialog = new ProgressDialog(EyeTattooCostFragment.this);
        ...
        protected void onPostExecute(String s) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(EyeTattooCostFragment.this, mClassicList,
                            R.layout.list_item,
                            new String[]{TAG_id,
