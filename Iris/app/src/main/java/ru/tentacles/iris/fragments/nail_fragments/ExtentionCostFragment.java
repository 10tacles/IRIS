...
public class ExtentionCostFragment extends FragmentActivity{
    ...
    class UpdateCost extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... args) {
            ...
            Intent en = getIntent();
            int r = en.getIntExtra("extention", 20);
            String id_nail = null;
            //В зависимости от позиции (нажатой кнопки) мы отправляем
            //в SQL запрос id требуемой нами услуги
            if (r == 0) {
                id_nail = "23";
                block_name.setText("Стандартное наращивание ногтей:");
            } else if (r == 1) {
                id_nail = "24";
                block_name.setText("Наращивание ногтей с дизайном:");
            } else if (r == 2) {
                id_nail = "25";
                block_name.setText("Наращивание ногтей French:");
            } else if (r == 3) {
                id_nail = "26";
                block_name.setText("Коррекция:");
            } else if (r == 4) {
                id_nail = "27";
                block_name.setText("Снятие искусственных ногтей:");
            }
    ...
    class LoadCost extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pDialog = new ProgressDialog(ExtentionCostFragment.this);
        ...
        protected void onPostExecute(String s) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(ExtentionCostFragment.this, mClassicList,
                            R.layout.list_item,
                            new String[]{TAG_id,
