...
public class makeupPermRightFragment extends ListFragment{

    public static final String TAG = "makeupPermRightFragmentTAG";
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent pe = new Intent(getActivity(), MakeupPermCostFragment.class);
        pe.putExtra("perm", position);
        startActivity(pe);
    }
}
